...
#+begin_src emacs-lisp
(after! forge
  (push `(,(getenv "EMACS_VF_HOST")                     ; GITHOST
          ,(concat (getenv "EMACS_VF_HOST") "/api/v1")  ; APIHOST
          ,(getenv "EMACS_VF_HOST")                     ; WEBHOST and INSTANCE-ID
...
** Copilot
#+begin_src emacs-lisp
(when (string= (getenv "EMACS_ENABLE_COPILOT") "true")
  (use-package! copilot
